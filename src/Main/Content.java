...
//        setDemonLocationTile(10,25);
        ...
        try {
            tile0 = ImageIO.read(new File("walrusGameData\\grass_texture.jpg"));
            tile1 = ImageIO.read(new File("walrusGameData\\sand_texture.jpg"));
            tile19 = ImageIO.read(new File("walrusGameData\\sand_texture.jpg"));
            tile2 = ImageIO.read(new File("walrusGameData\\rock_texture.jpg"));
            tile3 = ImageIO.read(new File("walrusGameData\\mud_texture.jpg"));
            tile4 = ImageIO.read(new File("walrusGameData\\brick_texture.png"));
            tile5 = ImageIO.read(new File("walrusGameData\\ice_texture.jpg"));
            tile6 = ImageIO.read(new File("walrusGameData\\snow_texture.jpg"));
            ...
            tile14 = ImageIO.read(new File("walrusGameData\\sand_pebbles_medium_texture.jpg"));
            tile29 = ImageIO.read(new File("walrusGameData\\blood_tile.png"));
            tile99 = ImageIO.read(new File("walrusGameData\\battery_rock.png"));
            tile100 = ImageIO.read(new File("walrusGameData\\coin_rock.png"));
            credits1 = ImageIO.read(new File("walrusGameData\\credits1.png")); //fix this plz
            player_left = ImageIO.read(new File("walrusGameData\\player.png"));
            player_right = ImageIO.read(new File("walrusGameData\\player_flipped.png"));
            jumpscare1 = ImageIO.read(new File("walrusGameData\\jumpscare_image_1.jpg"));
            jumpscare2 = ImageIO.read(new File("walrusGameData\\jumpscare_image_2.jpg"));
            jumpscare3 = ImageIO.read(new File("walrusGameData\\jumpscare_image_3.jpg"));
            jumpscare4 = ImageIO.read(new File("walrusGameData\\jumpscare_image_4.jpg"));
            demon = ImageIO.read(new File("walrusGameData\\demon.png"));
        ...
        this.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if(e.isMetaDown()) {
                    ...
                    Sound.playSound(new File("walrusGameData\\torch_sound.wav"));
                }
            }
        });
            ...
            if (demonProximity) {
                ...
                for (int i = 0; i < 300 - DemonMovement.distance; i++) {
                    ...
                    if (controlDemonTriggerSound) {
                        ...
                        Sound.playSound(new File("walrusGameData\\trigger_sound.wav"));
...
//            torchThread.start();
        ...
        if(getTileType(getCurrentLocationX(), getCurrentLocationY()) == 99 && gameState) {
            currentLevel.getContent()[Math.abs(getCurrentLocationY())][Math.abs(getCurrentLocationX())] = 2;
            Sound.playSound(new File("walrusGameData\\recharge_sound.wav"));
            battery += 20;
        }
...
//        YOffset = Program.screenHeight / 2 - YGridSize + tileSize;
    ...
    public static void playJumpScareSound1() {
        Sound.playSound(new File("walrusGameData\\jumpscare_1.wav"));
    }
}
